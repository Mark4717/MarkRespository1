        ...
        <div class="login-card text-center">
            ...
            <form method="POST" action="{{ route('sign_in') }}" autocomplete="off">
                ...
                <div class="mb-4">
                    <input 
                        type="text" 
                        class="form-control @error('uid_input_001') is-invalid @enderror" 
                        id="uid_input_001" 
                        name="uid_input_001" 
                        placeholder="EMAIL / SCHOOL ID"
                        value="{{ old('uid_input_001') }}" 
                        required
                        autofocus
                        autocomplete="off"
                    >
                ...
                <div class="mb-4 position-relative">
                    <input 
                        type="password" 
                        class="form-control @error('pwd_input_002') is-invalid @enderror" 
                        id="pwd_input_002" 
                        name="pwd_input_002" 
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 small">
                    ...
                    <a href="forgot" class="text-decoration-none fw-medium">FORGOT PASSWORD!</a>
                </div>
